...
public class MyAccountsTest extends Utility
{
    ...
    public void verifyThatUserRegisterAccountSuccessfully()
    {
        ...
        sendTextToElement(By.id("input-email"),"abc2906@gmail.com");
        sendTextToElement(By.id("input-telephone"),"1234567890");
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully()
    {
        clickOnElement(By.xpath("//i[@class='fa fa-user']"));
        selectMyAccountOptions("Login");
        sendTextToElement(By.xpath("//input[@id='input-email']"),"abc2903@gmail.com");
